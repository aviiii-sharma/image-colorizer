...
DIR = r"C:\Coding\MinorProject\image-colorizer\Colorizing-black-and-white-images-using-Python-master"
# Fix the path separators to use Windows style
...
if args["output"]:
    print(f"Saving colorized image to {args['output']}")
    cv2.imwrite(args["output"], colorized)
else:
    # Display the images if no output path
